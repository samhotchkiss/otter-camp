...
**Product domains** (core differentiators): Chat, Project, Agent, Memory. These define the user-facing experience.
...
**Infrastructure domains**: Model, Control Plane. These are operational infrastructure that supports the product domains but are not direct product differentiators.

- Model system owns provider abstraction, routing, and cost policy.
- Control Plane owns runs, tool executions, capability policies, and worker dispatch.
