...
For bootstrap-product auto-archives, the follow-on restart does not resume the failed project session. It creates a fresh live project and fresh project-scoped bootstrap session from the persisted canonical bundle, while the failed project/session tree stays archived for audit only.
