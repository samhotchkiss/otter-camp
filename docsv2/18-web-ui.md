...
- Runtime-health active/stale task counts exclude archived projects. Archived task trees remain available through project/task history, but they must not continue inflating the operator's live workload summary after archival.
