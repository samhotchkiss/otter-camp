...
func (r *ChatRouteRegistrar) RegisterRoutes(router chi.Router) {
	router.With(requireReadScope("chat")).Get("/chat-sessions", r.handlers.listSessions)
	router.With(requireWriteScope("chat")).Post("/chat-sessions", r.handlers.createSession)
	router.With(requireReadScope("chat")).Get("/chat-sessions/{id}", r.handlers.getSession)
	router.With(requireWriteScope("chat")).Patch("/chat-sessions/{id}", r.handlers.patchSession)
	router.With(requireWriteScope("chat")).Delete("/chat-sessions/{id}", r.handlers.deleteSession)

	router.With(requireReadScope("chat")).Get("/chat-sessions/{id}/messages", r.handlers.listMessages)
	router.With(requireReadScope("chat")).Get("/chat-sessions/{id}/messages/{mid}", r.handlers.getMessage)
	router.With(requireWriteScope("chat")).Post("/chat-sessions/{id}/messages", r.handlers.appendMessage)
	router.With(requireWriteScope("chat")).Patch("/chat-sessions/{id}/messages/{mid}", r.handlers.editQueuedMessage)
	router.With(requireReadScope("chat")).Get("/chat-sessions/{id}/turns", r.handlers.listTurns)

	router.With(requireWriteScope("chat")).Post("/chat-sessions/{id}/cancel-turn", r.handlers.cancelTurn)
	router.With(requireWriteScope("chat")).Post("/chat-sessions/{id}/messages/{mid}/steer", r.handlers.steerTurn)

	router.With(requireReadScope("chat")).Get("/chat-sessions/{id}/messages/{mid}/reactions", r.handlers.listReactions)
	router.With(requireWriteScope("chat")).Post("/chat-sessions/{id}/messages/{mid}/reactions", r.handlers.addReaction)
	router.With(requireWriteScope("chat")).Delete("/chat-sessions/{id}/messages/{mid}/reactions/{rid}", r.handlers.removeReaction)

	router.With(requireReadScope("chat")).Get("/chat-sessions/{id}/participants", r.handlers.listParticipants)
	router.With(requireWriteScope("chat")).Post("/chat-sessions/{id}/participants", r.handlers.addParticipant)
	router.With(requireWriteScope("chat")).Delete("/chat-sessions/{id}/participants/{pid}", r.handlers.removeParticipant)

	router.With(requireReadScope("chat")).Get("/chat-sessions/{id}/read-cursor", r.handlers.getReadCursor)
	router.With(requireWriteScope("chat")).Put("/chat-sessions/{id}/read-cursor", r.handlers.putReadCursor)

	router.With(requireReadScope("chat")).Get("/chat-sessions/{id}/artifacts", r.handlers.listArtifacts)
}
