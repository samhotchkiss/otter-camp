...
func (r *TaskRouteRegistrar) RegisterRoutes(router chi.Router) {
	router.With(requireReadScope("tasks")).Get("/projects/{id}/tasks", r.handlers.listProjectTasks)
	router.With(middleware.RequireRole("member"), requireWriteScope("tasks")).Post("/projects/{id}/tasks", r.handlers.createTask)

	router.With(requireReadScope("tasks")).Get("/tasks/{id}", r.handlers.getTask)
	router.With(middleware.RequireRole("member"), requireWriteScope("tasks")).Patch("/tasks/{id}", r.handlers.patchTask)
	router.With(middleware.RequireRole("member"), requireWriteScope("tasks")).Post("/tasks/{id}/queue", r.handlers.queueTask)
	router.With(middleware.RequireRole("member"), requireWriteScope("tasks")).Post("/tasks/{id}/cancel", r.handlers.cancelTask)
	router.With(middleware.RequireRole("member"), requireWriteScope("tasks")).Post("/tasks/{id}/advance-flow", r.handlers.advanceFlow)
	router.With(middleware.RequireRole("member"), requireWriteScope("tasks")).Post("/tasks/{id}/reject-flow", r.handlers.rejectFlow)
	router.With(middleware.RequireRole("member"), requireWriteScope("tasks")).Post("/tasks/{id}/review-decision", r.handlers.reviewDecision)

	router.With(requireReadScope("tasks")).Get("/tasks/{id}/flow", r.handlers.getTaskFlow)
	router.With(requireReadScope("tasks")).Get("/tasks/{id}/subtasks", r.handlers.listTaskSubtasks)
	router.With(middleware.RequireRole("member"), requireWriteScope("tasks")).Post("/tasks/{id}/subtasks", r.handlers.createTaskSubtask)
	router.With(middleware.RequireRole("member"), requireWriteScope("tasks")).Patch("/tasks/{id}/subtasks/{sid}", r.handlers.patchTaskSubtask)
	router.With(middleware.RequireRole("member"), requireWriteScope("tasks")).Post("/tasks/{id}/dependencies", r.handlers.addTaskDependency)
	router.With(middleware.RequireRole("member"), requireWriteScope("tasks")).Delete("/tasks/{id}/dependencies/{did}", r.handlers.deleteTaskDependency)
	router.With(requireReadScope("tasks")).Get("/tasks/{id}/events", r.handlers.listTaskEvents)
	router.With(requireReadScope("tasks")).Get("/tasks/{id}/participants", r.handlers.listTaskParticipants)

	router.With(requireReadScope("tasks")).Get("/inbox", r.handlers.listInbox)
	router.With(middleware.RequireRole("member"), requireWriteScope("tasks")).Post("/inbox/{id}/act", r.handlers.actOnInbox)

	router.With(requireReadScope("tasks")).Get("/projects/{id}/merge-queue", r.handlers.listMergeQueue)

	router.With(requireReadScope("tasks")).Get("/projects/{id}/remotes", r.handlers.listRemotes)
	router.With(middleware.RequireRole("admin"), requireWriteScope("tasks")).Post("/projects/{id}/remotes", r.handlers.createRemote)
	router.With(middleware.RequireRole("admin"), requireWriteScope("tasks")).Patch("/projects/{id}/remotes/{rid}", r.handlers.updateRemote)
	router.With(middleware.RequireRole("admin"), requireWriteScope("tasks")).Delete("/projects/{id}/remotes/{rid}", r.handlers.deleteRemote)

	router.With(requireReadScope("tasks")).Get("/projects/{id}/environments", r.handlers.listEnvironments)
	router.With(middleware.RequireRole("admin"), requireWriteScope("tasks")).Post("/projects/{id}/environments", r.handlers.createEnvironment)
	router.With(middleware.RequireRole("admin"), requireWriteScope("tasks")).Patch("/projects/{id}/environments/{eid}", r.handlers.updateEnvironment)
	router.With(middleware.RequireRole("admin"), requireWriteScope("tasks")).Post("/projects/{id}/deploy", r.handlers.deployProject)
	router.With(middleware.RequireRole("admin"), requireWriteScope("tasks")).Post("/projects/{id}/environments/{eid}/deploy", r.handlers.deployEnvironment)
	router.With(middleware.RequireRole("admin"), requireWriteScope("tasks")).Post("/projects/{id}/rollback", r.handlers.rollbackProject)
}
