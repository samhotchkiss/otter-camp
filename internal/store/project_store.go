...
const projectSelectColumns = "id, org_id, name, description, status, repo_url, local_repo_path, workflow_enabled, workflow_schedule, workflow_template, workflow_agent_id, workflow_last_run_at, workflow_next_run_at, workflow_run_count, created_at, updated_at"
...
func (s *ProjectStore) Update(ctx context.Context, id string, input UpdateProjectInput) (*Project, error) {
	...
	query := `UPDATE projects SET
		...
		workflow_enabled = $5, workflow_schedule = $6::jsonb, workflow_template = $7::jsonb,
		workflow_agent_id = $8, workflow_last_run_at = $9, workflow_next_run_at = $10, workflow_run_count = $11
