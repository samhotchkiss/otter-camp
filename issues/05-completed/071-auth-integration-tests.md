...
**ISSUE #1/#23 (RESOLVED) impact:** Budget fields are token-based (`budget_cap_tokens`) and
hierarchical/additive. Auth tests do not touch budget columns; no stub behavior needed here.
