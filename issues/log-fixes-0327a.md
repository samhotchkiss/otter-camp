...
- 2026-03-28 19:18:27 MDT - `pending` `Requeue blocked terminal recovery resumes before session cleanup`
  ...
  - live status: deployed once the runtime is restarted; Sam.blog task `70` session `30a79813-2880-4ae1-be7f-2dd76623f193` is the direct canary because it currently has an unconsumed `task_recovery_resume` for terminal execution `b46596fb-c15e-402f-8fa0-fcdb13dabe4b` and no live `agent_turn` job
