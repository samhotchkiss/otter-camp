CREATE TABLE audit_event (
    ...
    CONSTRAINT audit_event_delegation_pair_chk
        CHECK ((delegated_by_type IS NULL) = (delegated_by_id IS NULL))
);

CREATE INDEX audit_event_org_created_at_idx
    ON audit_event (organization_id, created_at DESC);

CREATE INDEX audit_event_org_principal_id_idx
...
CREATE INDEX audit_event_org_event_type_created_at_idx
