CREATE TABLE model_profile (
    ...
    invocation_purpose text NOT NULL DEFAULT 'agent_turn' CHECK (invocation_purpose IN (
        'agent_turn',
        'listening_eval',
        'summarization',
        'skill_summarization',
...
CREATE UNIQUE INDEX model_profile_logical_org_version_uniq_idx
    ON model_profile (logical_profile_id, COALESCE(organization_id, '00000000-0000-0000-0000-000000000000'::uuid), version);

CREATE UNIQUE INDEX model_profile_current_logical_org_uniq_idx
